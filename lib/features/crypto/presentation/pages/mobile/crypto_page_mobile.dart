...
class CryptoPageMobile extends StatefulWidget {
  const CryptoPageMobile({super.key});

  @override
  State<CryptoPageMobile> createState() => _CryptoPageMobileState();
}

class _CryptoPageMobileState extends State<CryptoPageMobile> {
